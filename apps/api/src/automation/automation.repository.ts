...
@Injectable()export class AutomationRepository extends ResourceRepository<'automationRule'>{constructor(db:DatabaseService,tenant:TenantContext){super(db,tenant,'automationRule',true);}}
