...
@Injectable() export class IntegrationsRepository extends ResourceRepository<'integrationConnection'> { constructor(db: DatabaseService, tenant: TenantContext) { super(db, tenant, 'integrationConnection'); } }
