      ...
      <div className="w-full max-w-4xl bg-[#1c2c3b]/90 backdrop-blur-2xl rounded-3xl border border-white/10 shadow-glass overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-8 md:p-10 flex flex-col justify-between">
          <div>
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-400 to-amber-500 flex items-center justify-center text-slate-950 shadow-md shadow-amber-500/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-slate-950 font-extrabold rounded-xl text-xs shadow-lg shadow-amber-500/20 flex items-center justify-center gap-2 transition-all disabled:opacity-75 mt-2"
              >
                {loading ? (
        ...
        <div className="bg-gradient-to-br from-[#1d2d3c] via-[#16232f] to-[#0f1720] p-8 md:p-10 text-white flex flex-col justify-between relative overflow-hidden hidden md:flex border-l border-white/10">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 border border-white/15 text-[11px] font-semibold tracking-wide backdrop-blur-md mb-6 text-amber-300">
          ...
          <div className="relative z-10 p-5 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md space-y-3">
            ...
            <div className="flex items-center gap-3 pt-2 border-t border-white/10">
              <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-amber-400 to-amber-500 font-bold text-[10px] flex items-center justify-center text-slate-950">
                SJ
              </div>
              <div>
